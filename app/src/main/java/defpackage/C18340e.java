...
/* renamed from: eْۙ, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C18340e extends AbstractC3405e implements InterfaceC10218e {
    private static final C18340e DEFAULT_INSTANCE;
    public static final int IV_SIZE_FIELD_NUMBER = 1;
    private static volatile InterfaceC5309e PARSER;
    private int ivSize_;

    /* JADX WARN: Type inference failed for: r0v0, types: [eٖؕۢ, eْۙ] */
    static {
        ?? abstractC3405e = new AbstractC3405e();
        DEFAULT_INSTANCE = abstractC3405e;
        AbstractC3405e.tapsense(C18340e.class, abstractC3405e);
    }

    public static C18340e ads() {
        return DEFAULT_INSTANCE;
    }

    public static void applovin(C18340e c18340e, int i) {
        c18340e.ivSize_ = i;
    }

    public static C2551e subs() {
        return (C2551e) DEFAULT_INSTANCE.yandex();
    }
