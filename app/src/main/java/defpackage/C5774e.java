...
/* renamed from: eؘٝۤ, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C5774e extends AbstractC2040e {
    ...
    public C5774e() {
        ...
        this.f12213e = new int[16];
        AbstractC5336e.license(this);
        AbstractC9915e.ad();
        reset();
    }

    public C5774e(C5774e c5774e) {
        super(c5774e.f5319e);
        this.f12213e = new int[16];
        AbstractC5336e.license(this);
        AbstractC9915e.ad();
    ...
    public final int doFinal(byte[] bArr, int i) {
        appmetrica();
        AbstractC3628e.yandex(this.f12210e, i, bArr);
        AbstractC3628e.yandex(this.f12215e, i + 4, bArr);
        AbstractC3628e.yandex(this.f12214e, i + 8, bArr);
        AbstractC3628e.yandex(this.f12212e, i + 12, bArr);
        reset();
        return 16;
    }
    ...
    public final void purchase() {
        ...
        int adcel = adcel(startapp13, startapp16, startapp15, startapp14, iArr[7], 7);
        ...
        int mopub = mopub(adcel13, adcel16, adcel15, adcel14, iArr[3], 11);
        int mopub2 = mopub(adcel14, mopub, adcel16, adcel15, iArr[10], 13);
        int mopub3 = mopub(adcel15, mopub2, mopub, adcel16, iArr[14], 6);
        int mopub4 = mopub(adcel16, mopub3, mopub2, mopub, iArr[4], 7);
        ...
        int advert = advert(mopub13, mopub16, mopub15, mopub14, iArr[1], 11);
        int advert2 = advert(mopub14, advert, mopub16, mopub15, iArr[9], 12);
        int advert3 = advert(mopub15, advert2, advert, mopub16, iArr[11], 14);
        ...
        int Signature = Signature(i, i2, i3, i4, iArr[5], 8);
        int Signature2 = Signature(i4, Signature, i2, i3, iArr[14], 9);
        int Signature3 = Signature(i3, Signature2, Signature, i2, iArr[7], 9);
        int Signature4 = Signature(i2, Signature3, Signature2, Signature, iArr[0], 11);
        ...
        int loadAd = loadAd(Signature13, Signature16, Signature15, Signature14, iArr[6], 9);
        ...
        int amazon = amazon(loadAd13, loadAd16, loadAd15, loadAd14, iArr[15], 9);
        int amazon2 = amazon(loadAd14, amazon, loadAd16, loadAd15, iArr[5], 7);
        int amazon3 = amazon(loadAd15, amazon2, amazon, loadAd16, iArr[1], 15);
        int amazon4 = amazon(loadAd16, amazon3, amazon2, amazon, iArr[3], 11);
        ...
        int smaato = smaato(amazon13, amazon16, amazon15, amazon14, iArr[8], 15);
        int smaato2 = smaato(amazon14, smaato, amazon16, amazon15, iArr[6], 5);
        int smaato3 = smaato(amazon15, smaato2, smaato, amazon16, iArr[4], 8);
        ...
        int i5 = advert15 + this.f12215e + smaato14;
        this.f12215e = this.f12214e + advert14 + smaato13;
        this.f12214e = this.f12212e + advert13 + smaato16;
        this.f12212e = this.f12210e + advert16 + smaato15;
        this.f12210e = i5;
        this.f12211e = 0;
    ...
    public final void reset() {
        super.reset();
        this.f12210e = 1732584193;
        this.f12215e = -271733879;
        this.f12214e = -1732584194;
        this.f12212e = 271733878;
        this.f12211e = 0;
        int i = 0;
        while (true) {
            int[] iArr = this.f12213e;
    ...
    public final void subscription(C5774e c5774e) {
        license(c5774e);
        this.f12210e = c5774e.f12210e;
        this.f12215e = c5774e.f12215e;
        this.f12214e = c5774e.f12214e;
        this.f12212e = c5774e.f12212e;
        int[] iArr = c5774e.f12213e;
        System.arraycopy(iArr, 0, this.f12213e, 0, iArr.length);
        this.f12211e = c5774e.f12211e;
    }

    @Override // defpackage.InterfaceC0554e
    public final void vip(InterfaceC0554e interfaceC0554e) {
        subscription((C5774e) interfaceC0554e);
    }
    ...
    public final void yandex(int i, byte[] bArr) {
        int i2 = this.f12211e;
        this.f12211e = i2 + 1;
        this.f12213e[i2] = AbstractC3628e.advert(i, bArr);
        if (this.f12211e == 16) {
            purchase();
        }
    }
