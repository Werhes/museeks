...
/* renamed from: eٌٟؗ, reason: invalid class name and case insensitive filesystem */
...
public abstract class AbstractC5068e {
    ...
    */
    public static void metrica(defpackage.AbstractC18270e r21, java.lang.StringBuilder r22, int r23) {
        /*
            Method dump skipped, instructions count: 551
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.AbstractC5068e.metrica(eٟؓ, java.lang.StringBuilder, int):void");
    }
    ...
    public static void vip(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof String) {
            ...
            sb.append(AbstractC13438e.vip(new C6283e(((String) obj).getBytes(AbstractC2930e.ad))));
            sb.append('\"');
            return;
        }
        if (obj instanceof C6283e) {
            sb.append(": \"");
            sb.append(AbstractC13438e.vip((C6283e) obj));
            sb.append('\"');
            return;
        }
        if (obj instanceof AbstractC18270e) {
            sb.append(" {");
            metrica((AbstractC18270e) obj, sb, i + 2);
            sb.append("\n");
            ad(i, sb);
            sb.append("}");
            return;
