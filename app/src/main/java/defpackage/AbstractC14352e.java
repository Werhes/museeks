...
/* renamed from: eؙٓۤ, reason: invalid class name and case insensitive filesystem */
...
public abstract class AbstractC14352e {
    ...
    public static final AbstractC5597e metrica;
    ...
    static {
        Unsafe adcel = adcel();
        ad = adcel;
        vip = AbstractC10493e.ad;
        boolean purchase2 = purchase(Long.TYPE);
        boolean purchase3 = purchase(Integer.TYPE);
        AbstractC5597e abstractC5597e = null;
        if (adcel != null) {
            if (!AbstractC10493e.ad()) {
                abstractC5597e = new AbstractC5597e(adcel);
            } else if (purchase2) {
                abstractC5597e = new C3142e(adcel, 1);
            } else if (purchase3) {
                abstractC5597e = new C3142e(adcel, 0);
            }
        }
        metrica = abstractC5597e;
        license = abstractC5597e == null ? false : abstractC5597e.remoteconfig();
        appmetrica = abstractC5597e == null ? false : abstractC5597e.subscription();
        ...
        if (appmetrica2 != null && abstractC5597e != null) {
            abstractC5597e.adcel(appmetrica2);
        }
    ...
    public static void ad(Throwable th) {
        Logger.getLogger(AbstractC14352e.class.getName()).log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: " + th);
    }
