...
/* renamed from: eؚٟؑ, reason: invalid class name and case insensitive filesystem */
...
public final class C6853e {
    ...
    public C6853e(float f, float f2, float f3, float f4, float f5, float f6) {
        this.ad = f;
        this.vip = f2;
        this.metrica = f3;
        this.license = f4;
    ...
    public static C6853e ad(int i) {
        C2973e c2973e = C2973e.mopub;
        float appmetrica = AbstractC8230e.appmetrica(Color.red(i));
        float appmetrica2 = AbstractC8230e.appmetrica(Color.green(i));
        float appmetrica3 = AbstractC8230e.appmetrica(Color.blue(i));
        float[][] fArr = AbstractC8230e.appmetrica;
        float[] fArr2 = fArr[0];
        float f = (fArr2[2] * appmetrica3) + (fArr2[1] * appmetrica2) + (fArr2[0] * appmetrica);
        float[] fArr3 = fArr[1];
        float f2 = (fArr3[2] * appmetrica3) + (fArr3[1] * appmetrica2) + (fArr3[0] * appmetrica);
        float[] fArr4 = fArr[2];
        float f3 = (appmetrica3 * fArr4[2]) + (appmetrica2 * fArr4[1]) + (appmetrica * fArr4[0]);
        float[][] fArr5 = AbstractC8230e.vip;
        float[] fArr6 = fArr5[0];
        ...
        float[] fArr9 = c2973e.billing;
        float f7 = c2973e.startapp;
        float f8 = c2973e.license;
        float f9 = c2973e.ad;
        float f10 = fArr9[0] * f4;
        float f11 = fArr9[1] * f5;
        float f12 = fArr9[2] * f6;
        float f13 = c2973e.yandex;
        ...
        float pow4 = ((float) Math.pow((f18 * c2973e.vip) / f9, c2973e.adcel * f8)) * 100.0f;
        Math.sqrt(pow4 / 100.0f);
        float f20 = f9 + 4.0f;
        float pow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, c2973e.purchase), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos((((((double) atan2) < 20.14d ? 360.0f + atan2 : atan2) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * c2973e.appmetrica) * c2973e.metrica) * ((float) Math.sqrt((f15 * f15) + (f14 * f14)))) / (f17 + 0.305f), 0.9d)) * ((float) Math.sqrt(pow4 / 100.0d));
        Math.sqrt((r0 * f8) / f20);
        float f21 = (1.7f * pow4) / ((0.007f * pow4) + 1.0f);
        float log = ((float) Math.log((f7 * pow5 * 0.0228f) + 1.0f)) * 43.85965f;
        double d2 = f19;
        return new C6853e(atan2, pow5, pow4, f21, log * ((float) Math.cos(d2)), log * ((float) Math.sin(d2)));
    }

    public static C6853e vip(float f, float f2, float f3) {
        C2973e c2973e = C2973e.mopub;
        float f4 = c2973e.license;
        Math.sqrt(f / 100.0d);
        float f5 = c2973e.ad + 4.0f;
        float f6 = c2973e.startapp * f2;
        Math.sqrt(((f2 / ((float) Math.sqrt(r1))) * c2973e.license) / f5);
        float f7 = (1.7f * f) / ((0.007f * f) + 1.0f);
        float log = ((float) Math.log((f6 * 0.0228d) + 1.0d)) * 43.85965f;
        double d = (3.1415927f * f3) / 180.0f;
        return new C6853e(f3, f2, f, f7, log * ((float) Math.cos(d)), log * ((float) Math.sin(d)));
    }

    public final int metrica(C2973e c2973e) {
        float f;
        float f2 = this.vip;
        double d = f2;
        ...
        if (d != 0.0d) {
            ...
            if (d2 != 0.0d) {
                ...
                float f4 = c2973e.purchase;
                float f5 = c2973e.yandex;
                float pow = (float) Math.pow(f / Math.pow(1.64d - Math.pow(0.29d, f4), 0.73d), 1.1111111111111112d);
                double d3 = (this.ad * 3.1415927f) / 180.0f;
                float cos = ((float) (Math.cos(2.0d + d3) + 3.8d)) * 0.25f;
                float pow2 = c2973e.ad * ((float) Math.pow(f3 / 100.0d, (1.0d / c2973e.license) / c2973e.adcel));
                float f6 = cos * 3846.1538f * c2973e.appmetrica * c2973e.metrica;
                float f7 = pow2 / c2973e.vip;
                ...
                float[] fArr = c2973e.billing;
                float f16 = signum / fArr[0];
                float f17 = signum2 / fArr[1];
                float f18 = signum3 / fArr[2];
                float[][] fArr2 = AbstractC8230e.metrica;
                float[] fArr3 = fArr2[0];
                float f19 = (fArr3[2] * f18) + (fArr3[1] * f17) + (fArr3[0] * f16);
                float[] fArr4 = fArr2[1];
                float f20 = (fArr4[2] * f18) + (fArr4[1] * f17) + (fArr4[0] * f16);
                float[] fArr5 = fArr2[2];
                return AbstractC3898e.vip(f19, f20, (f18 * fArr5[2]) + (f17 * fArr5[1]) + (f16 * fArr5[0]));
            }
        }
        f = 0.0f;
        float f42 = c2973e.purchase;
        float f52 = c2973e.yandex;
        float pow3 = (float) Math.pow(f / Math.pow(1.64d - Math.pow(0.29d, f42), 0.73d), 1.1111111111111112d);
        double d32 = (this.ad * 3.1415927f) / 180.0f;
        float cos3 = ((float) (Math.cos(2.0d + d32) + 3.8d)) * 0.25f;
        float pow22 = c2973e.ad * ((float) Math.pow(f3 / 100.0d, (1.0d / c2973e.license) / c2973e.adcel));
        float f62 = cos3 * 3846.1538f * c2973e.appmetrica * c2973e.metrica;
        float f72 = pow22 / c2973e.vip;
