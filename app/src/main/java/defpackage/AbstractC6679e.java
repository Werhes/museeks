...
/* renamed from: eؙۜۨ, reason: invalid class name and case insensitive filesystem */
...
public abstract class AbstractC6679e {
    ...
    */
    public AbstractC6679e(java.lang.String r8, java.lang.String r9) {
        /*
            r7 = this;
            ...
            int r8 = defpackage.AbstractC7328e.mopub(r3, r8)     // Catch: java.lang.IllegalArgumentException -> L6d java.lang.IllegalStateException -> L71
            r3 = 35632(0x8b30, float:4.9931E-41)
            int r9 = defpackage.AbstractC7328e.mopub(r3, r9)     // Catch: java.lang.IllegalArgumentException -> L67 java.lang.IllegalStateException -> L6b
            ...
            defpackage.AbstractC7328e.vip(r4)     // Catch: java.lang.IllegalArgumentException -> L48 java.lang.IllegalStateException -> L4a
            ...
            defpackage.AbstractC7328e.vip(r0)     // Catch: java.lang.IllegalArgumentException -> L48 java.lang.IllegalStateException -> L4a
            ...
            if (r4 != r0) goto L4c
            r7.ad = r3     // Catch: java.lang.IllegalArgumentException -> L48 java.lang.IllegalStateException -> L4a
            r7.ad()
            return
        L48:
            r0 = move-exception
        ...
        L82:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.AbstractC6679e.<init>(java.lang.String, java.lang.String):void");
    }

    public final void ad() {
        int i = this.ad;
        int glGetAttribLocation = GLES20.glGetAttribLocation(i, "aPosition");
        this.license = glGetAttribLocation;
        AbstractC7328e.appmetrica(glGetAttribLocation, "aPosition");
        int glGetUniformLocation = GLES20.glGetUniformLocation(i, "uTransMatrix");
        this.vip = glGetUniformLocation;
        AbstractC7328e.appmetrica(glGetUniformLocation, "uTransMatrix");
        int glGetUniformLocation2 = GLES20.glGetUniformLocation(i, "uAlphaScale");
        this.metrica = glGetUniformLocation2;
        AbstractC7328e.appmetrica(glGetUniformLocation2, "uAlphaScale");
    }

    public void vip() {
        GLES20.glUseProgram(this.ad);
        AbstractC7328e.vip("glUseProgram");
        GLES20.glEnableVertexAttribArray(this.license);
        AbstractC7328e.vip("glEnableVertexAttribArray");
        GLES20.glVertexAttribPointer(this.license, 2, 5126, false, 0, (Buffer) AbstractC7328e.yandex);
        AbstractC7328e.vip("glVertexAttribPointer");
        float[] fArr = new float[16];
        Matrix.setIdentityM(fArr, 0);
        GLES20.glUniformMatrix4fv(this.vip, 1, false, fArr, 0);
        AbstractC7328e.vip("glUniformMatrix4fv");
        GLES20.glUniform1f(this.metrica, 1.0f);
