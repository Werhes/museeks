...
/* renamed from: eُؖؓ, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes.dex */
public final class C10797e extends AbstractC16625e {

    /* renamed from: eَٕٞ, reason: contains not printable characters */
    public final String f21406e;

    /* renamed from: eّٜۦ, reason: contains not printable characters */
    public final C1615e f21407e;

    /* renamed from: eْٖٓ, reason: contains not printable characters */
    public final InterfaceC1108e f21408e;

    public C10797e(String str) {
        this.f21406e = str;
        C1615e metrica = AbstractC9180e.metrica(str);
        this.f21407e = metrica;
        this.f21408e = AbstractC7535e.smaato(new C14571e(metrica, 1), AbstractC6731e.ad);
    }

    /* renamed from: switch, reason: not valid java name */
    public static final void m2930switch(C10797e c10797e, CachedTrack cachedTrack, InterfaceC8346e interfaceC8346e) {
        AppActivity appActivity = (AppActivity) c10797e.pro();
    ...
    public final void m2931else(String str, Function1 function1, Function1 function12, InterfaceC12864e interfaceC12864e, boolean z, Function2 function2, Function2 function22, C17085e c17085e, C15274e c15274e, C13770e c13770e, int i) {
        boolean z2;
        C15274e c15274e2;
        C15274e c15274e3;
        boolean z3;
        c13770e.m3671package(909874670);
        ...
        if (c13770e.m3673protected(i2 & 1, (306783379 & i2) != 306783378)) {
            ...
            if (yandex || m3681throw3 == obj) {
                m3681throw3 = new C13563e(interfaceC16054e, function12, str, 1);
                c13770e.m3682throws(m3681throw3);
            }
            boolean z4 = z3;
            AbstractC0483e.license(str, function1, license, z4, purchase, c4988e, new C16636e(null, (Function1) m3681throw3, 47), true, 0, 0, null, null, c15274e4, c18466e, AbstractC16653e.license(-910097813, new C10353e(str, z4, c15274e4, function2, function22, c17085e, 1), c13770e), c13770e, i4 | 102236160 | (i2 & 112) | 3072, 199680, 7696);
            Unit unit = Unit.INSTANCE;
            Object m3681throw4 = c13770e.m3681throw();
            if (m3681throw4 == obj) {
                m3681throw4 = new C18066e(c6260e, null, 1);
        ...
        if (subscription != null) {
            subscription.license = new C9305e(this, str, function1, function12, interfaceC12864e, z2, function2, function22, c17085e, c15274e2, i, 2);
        }
    }
    ...
    public final void mo212final(C13770e c13770e, int i) {
        c13770e.m3671package(2009944829);
        int i2 = i | (c13770e.yandex(this) ? 4 : 2);
        if (c13770e.m3673protected(i2 & 1, (i2 & 3) != 2)) {
            C1615e c1615e = this.f21407e;
            C4891e c4891e = this.f27449e;
            AbstractC13348e.ad(null, AbstractC16653e.license(2088216001, new C8328e(this, AbstractC4628e.appmetrica(c1615e, c4891e, c13770e), 0), c13770e), null, null, null, 0, 0L, 0L, ((C0916e) c13770e.adcel(AbstractC12450e.ad)).license(c13770e), AbstractC16653e.license(1871718156, new C7373e(this, AbstractC4628e.metrica(this.f21408e, new C2765e(), c4891e, c13770e, 0, 12), 0), c13770e), c13770e, 805306416, 253);
        } else {
            c13770e.m3659default();
        }
        C2846e subscription = c13770e.subscription();
        if (subscription != null) {
            subscription.license = new C3471e(this, i, 0);
        }
    }

    /* renamed from: import, reason: not valid java name */
    public final void m2932import(String str, String str2, C13770e c13770e, int i, int i2) {
        String str3;
        int i3;
        boolean z;
        c13770e.m3671package(257936987);
        ...
        if (c13770e.m3673protected(i6 & 1, (i6 & 19) != 18)) {
            ...
            if (str4 != null) {
                c13770e2.m3676strictfp(911302644);
                String str5 = str4;
                ...
                str3 = str4;
                z = false;
                c13770e2.m3676strictfp(897301091);
            }
        ...
        C2846e subscription = c13770e.subscription();
        if (subscription != null) {
            subscription.license = new C9381e(i, i2, 20, this, str, str3);
        }
    }

    /* renamed from: instanceof, reason: not valid java name */
    public final void m2933instanceof(CachedPlaylist cachedPlaylist, C13770e c13770e, int i) {
        C13770e c13770e2 = c13770e;
        c13770e2.m3671package(-290279759);
        ...
        if (c13770e2.m3673protected(i2 & 1, (i2 & 19) != 18)) {
            ...
            if (yandex || m3681throw == c5170e) {
                m3681throw = new C5565e(this, cachedPlaylist, 15);
        ...
        if (subscription != null) {
            subscription.license = new C15709e(this, cachedPlaylist, i, 26);
        }
    }

    /* renamed from: return, reason: not valid java name */
    public final void m2934return(CachedTrack cachedTrack, Function0 function0, Function0 function02, C13770e c13770e, int i) {
        C13770e c13770e2;
        c13770e.m3671package(1090755532);
        ...
        if (c13770e.m3673protected(i2 & 1, (i2 & 1171) != 1170)) {
            c13770e2 = c13770e;
            AbstractC6401e.vip(AbstractC16653e.license(-824293670, new C11828e(this, cachedTrack, 13), c13770e), AbstractC16653e.license(886984697, new C14521e(cachedTrack, 8), c13770e), AbstractC12220e.advert(AbstractC18007e.metrica(AbstractC9546e.purchase(C0115e.f1276e, function02, function0), 1.0f), 16, 6), AbstractC16653e.license(14574135, new C14521e(cachedTrack, 9), c13770e), c13770e2, 3126, 0);
        } else {
            c13770e2 = c13770e;
            c13770e2.m3659default();
        }
        C2846e subscription = c13770e2.subscription();
        if (subscription != null) {
            subscription.license = new C6409e(this, cachedTrack, function0, function02, i, 24);
        }
    }

    /* renamed from: synchronized, reason: not valid java name */
    public final void m2935synchronized(InterfaceC8346e interfaceC8346e, C13770e c13770e, int i) {
        c13770e.m3671package(-2028090815);
        ...
        if (c13770e.m3673protected(i2 & 1, (i2 & 19) != 18)) {
            ...
            if (yandex || m3681throw == C2987e.ad) {
                m3681throw = new C6538e(interfaceC8346e, this, 15);
        ...
        C2846e subscription = c13770e.subscription();
        if (subscription != null) {
            subscription.license = new C15709e(this, interfaceC8346e, i, 25);
        }
    }

    /* renamed from: transient, reason: not valid java name */
    public final void m2936transient(C13770e c13770e, int i) {
        C13770e c13770e2 = c13770e;
        c13770e2.m3671package(-1771692608);
        int i2 = i & 1;
        ...
        C2846e subscription = c13770e2.subscription();
        if (subscription != null) {
            subscription.license = new C3471e(this, i, 3);
        }
    }
}
