...
/* renamed from: eؒؑۙ, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes.dex */
public final class C0775e extends AbstractC5918e {
    ...
    public final InterfaceC2209e ad() {
        ...
        c0775e.metrica = this.metrica;
        c0775e.license = this.license;
        c0775e.appmetrica = this.appmetrica;
    ...
    public final String toString() {
        return "EmittableRow(modifier=" + this.metrica + ", horizontalAlignment=" + ((Object) C2782e.vip(this.license)) + ", verticalAlignment=" + ((Object) C13692e.vip(this.appmetrica)) + ", children=[\n" + license() + "\n])";
    }
