...
/* renamed from: eٔ۠ٛ, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C15015e implements InterfaceC2227e, InterfaceC17128e {

    /* renamed from: eّؑؑ, reason: contains not printable characters */
    public Object f29752e;
    ...
    public C15015e(byte b, int i) {
        ...
        switch (i) {
            ...
            default:
                this.f29753e = false;
                this.f29754e = null;
                this.f29756e = new int[PSKKeyManager.MAX_KEY_LENGTH_BYTES];
                this.f29752e = new int[PSKKeyManager.MAX_KEY_LENGTH_BYTES];
                this.f29759e = new int[PSKKeyManager.MAX_KEY_LENGTH_BYTES];
                this.f29758e = new int[PSKKeyManager.MAX_KEY_LENGTH_BYTES];
                this.f29755e = new int[18];
                ((C13246e) AbstractC9915e.appmetrica.get()).getClass();
                return;
        }
    }

    public C15015e(int i) {
        this.f29757e = 2;
        C11511e c11511e = new C11511e(i);
        this.f29756e = c11511e;
        int i2 = c11511e.f23139e << 3;
        this.f29754e = new byte[i2 / 2];
        this.f29759e = new byte[i2];
        this.f29758e = new byte[i2];
        this.f29755e = new ArrayList();
        this.f29752e = new byte[4];
    }
    ...
    public byte[] billing(int i, byte[] bArr) {
        switch (this.f29757e) {
            case 1:
                ...
                int isPro = ((C8011e) this.f29756e).f16252e.isPro();
                if (i % isPro != 0) {
                    throw new Exception(AbstractC1786e.admob(isPro, "Ciphertext not multiple of "));
                }
                ((C8011e) this.f29756e).init(false, new C11494e((C14915e) this.f29752e, f29749e, 0, 8));
                byte[] bArr2 = new byte[i];
                for (int i2 = 0; i2 != i; i2 += isPro) {
                    ((C8011e) this.f29756e).tapsense(i2, i2, bArr, bArr2);
                }
                AbstractC12442e.crashlytics(bArr2);
                byte[] bArr3 = new byte[8];
                this.f29754e = bArr3;
                int i3 = i - 8;
                byte[] bArr4 = new byte[i3];
                System.arraycopy(bArr2, 0, bArr3, 0, 8);
                System.arraycopy(bArr2, 8, bArr4, 0, i3);
                C11494e c11494e = new C11494e((C14915e) this.f29752e, this.f29754e);
                this.f29759e = c11494e;
                ((C8011e) this.f29756e).init(false, c11494e);
                byte[] bArr5 = new byte[i3];
                for (int i4 = 0; i4 != i3; i4 += isPro) {
                    ((C8011e) this.f29756e).tapsense(i4, i4, bArr4, bArr5);
                }
                int i5 = i - 16;
                ...
                C12013e c12013e = (C12013e) this.f29758e;
                c12013e.update(bArr6, 0, i5);
                byte[] bArr9 = (byte[]) this.f29755e;
                c12013e.doFinal(bArr9, 0);
                System.arraycopy(bArr9, 0, bArr8, 0, 8);
                if (AbstractC12442e.loadAd(bArr8, bArr7)) {
                    return bArr6;
                }
                throw new Exception("Checksum inside ciphertext is corrupted");
            default:
                byte[] bArr10 = (byte[]) this.f29759e;
                byte[] bArr11 = (byte[]) this.f29752e;
                ArrayList arrayList = (ArrayList) this.f29755e;
                C11511e c11511e = (C11511e) this.f29756e;
                if (this.f29753e) {
                    throw new IllegalStateException("not set for unwrapping");
                }
                int i6 = c11511e.f23139e;
                int i7 = c11511e.f23139e;
                int i8 = i6 << 3;
                if (i % i8 != 0) {
                    throw new RuntimeException(AbstractC17861e.smaato(i7 << 3, " bytes", new StringBuilder("unwrap data must be a multiple of ")));
                }
                int i9 = (i * 2) / i8;
                int i10 = i9 - 1;
                int i11 = i10 * 6;
                byte[] bArr12 = new byte[i];
                System.arraycopy(bArr, 0, bArr12, 0, i);
                int i12 = 2;
                int i13 = (i7 << 3) / 2;
                byte[] bArr13 = new byte[i13];
                System.arraycopy(bArr12, 0, bArr13, 0, i13);
                arrayList.clear();
                int i14 = (i7 << 3) / 2;
                int i15 = i - i14;
                while (i15 != 0) {
                    ...
                    System.arraycopy(bArr12, i14, bArr14, 0, i17);
                ...
                int i22 = 0;
                while (i22 < i11) {
                    System.arraycopy(arrayList.get(i9 - 2), 0, bArr12, 0, (i20 << 3) / 2);
                    int i23 = (i20 << 3) / 2;
                    System.arraycopy(bArr13, 0, bArr12, i23, i23);
                    appmetrica(i11 - i22, bArr11);
                    for (int i24 = 0; i24 < 4; i24++) {
                        int i25 = ((i20 << 3) / 2) + i24;
                        bArr12[i25] = (byte) (bArr12[i25] ^ bArr11[i24]);
                    }
                    c11511e.tapsense(0, 0, bArr12, bArr12);
                    System.arraycopy(bArr12, 0, bArr13, 0, (i20 << 3) / 2);
                    int i26 = i21;
                    while (i26 < i9) {
                        int i27 = i9 - i26;
                        System.arraycopy(arrayList.get(i27 - 1), 0, arrayList.get(i27), 0, (i20 << 3) / 2);
                        i26++;
                        i22 = i22;
                    }
                    System.arraycopy(bArr12, (i20 << 3) / 2, arrayList.get(0), 0, (i20 << 3) / 2);
                    i22++;
                }
                System.arraycopy(bArr13, 0, bArr12, 0, (i20 << 3) / 2);
                int i28 = (i20 << 3) / 2;
                for (int i29 = 0; i29 < i10; i29++) {
                    System.arraycopy(arrayList.get(i29), 0, bArr12, i28, (i20 << 3) / 2);
                    i28 += (i20 << 3) / 2;
                }
                int i30 = i20 << 3;
                System.arraycopy(bArr12, i - i30, bArr10, 0, i30);
                byte[] bArr15 = new byte[i - (i20 << 3)];
                if (!Arrays.equals(bArr10, (byte[]) this.f29758e)) {
                    throw new Exception("checksum failed");
                }
                System.arraycopy(bArr12, 0, bArr15, 0, i - (i20 << 3));
                return bArr15;
        }
    }
    ...
    public final void init(boolean z, InterfaceC3894e interfaceC3894e) {
        SecureRandom vip;
        InterfaceC3894e interfaceC3894e2 = interfaceC3894e;
        switch (this.f29757e) {
            case 0:
                if (!(interfaceC3894e2 instanceof C14915e)) {
                    throw new IllegalArgumentException(AbstractC8703e.remoteconfig("invalid parameter passed to Blowfish init - ", interfaceC3894e2));
                }
                this.f29753e = z;
                byte[] bArr = ((C14915e) interfaceC3894e2).f29591e;
                this.f29754e = bArr;
                int[] iArr = (int[]) this.f29758e;
                int[] iArr2 = (int[]) this.f29759e;
                int[] iArr3 = (int[]) this.f29752e;
                int[] iArr4 = (int[]) this.f29756e;
                int[] iArr5 = (int[]) this.f29755e;
                int i = 4;
                if (bArr.length < 4 || bArr.length > 56) {
                    throw new IllegalArgumentException("key length must be in range 32 to 448 bits");
                }
                System.arraycopy(f29748e, 0, iArr4, 0, PSKKeyManager.MAX_KEY_LENGTH_BYTES);
                System.arraycopy(f29750e, 0, iArr3, 0, PSKKeyManager.MAX_KEY_LENGTH_BYTES);
                System.arraycopy(f29747e, 0, iArr2, 0, PSKKeyManager.MAX_KEY_LENGTH_BYTES);
                System.arraycopy(f29746e, 0, iArr, 0, PSKKeyManager.MAX_KEY_LENGTH_BYTES);
                System.arraycopy(f29751e, 0, iArr5, 0, 18);
                ...
                if (interfaceC3894e2 instanceof EnumC0300e) {
            ...
            case 1:
                this.f29753e = z;
                this.f29756e = new C8011e(new C7771e());
                if (interfaceC3894e2 instanceof C12219e) {
                    C12219e c12219e = (C12219e) interfaceC3894e2;
                    interfaceC3894e2 = c12219e.f24537e;
                    vip = c12219e.f24538e;
                } else {
                    vip = AbstractC9915e.vip();
                }
                if (interfaceC3894e2 instanceof C14915e) {
                    this.f29752e = (C14915e) interfaceC3894e2;
                    if (this.f29753e) {
                        byte[] bArr2 = new byte[8];
                        this.f29754e = bArr2;
                        vip.nextBytes(bArr2);
                        this.f29759e = new C11494e((C14915e) this.f29752e, this.f29754e);
                        return;
                    }
                    return;
                }
                if (interfaceC3894e2 instanceof C11494e) {
                    C11494e c11494e = (C11494e) interfaceC3894e2;
                    this.f29759e = c11494e;
                    byte[] bArr3 = c11494e.f23095e;
                    this.f29754e = bArr3;
                    this.f29752e = (C14915e) c11494e.f23094e;
                    if (!this.f29753e) {
            ...
            default:
                if (interfaceC3894e2 instanceof C12219e) {
                    interfaceC3894e2 = ((C12219e) interfaceC3894e2).f24537e;
                }
                this.f29753e = z;
                if (!(interfaceC3894e2 instanceof C14915e)) {
                    throw new IllegalArgumentException("invalid parameters passed to DSTU7624WrapEngine");
                }
                ((C11511e) this.f29756e).init(z, interfaceC3894e2);
                return;
        }
    }
    ...
    public byte[] license(int i, byte[] bArr) {
        switch (this.f29757e) {
            case 1:
                ...
                byte[] bArr3 = new byte[8];
                C12013e c12013e = (C12013e) this.f29758e;
                c12013e.update(bArr2, 0, i);
                byte[] bArr4 = (byte[]) this.f29755e;
                c12013e.doFinal(bArr4, 0);
                ...
                ((C8011e) this.f29756e).init(true, (C11494e) this.f29759e);
                byte[] bArr6 = new byte[i2];
                for (int i3 = 0; i3 != i2; i3 += isPro) {
                    ((C8011e) this.f29756e).tapsense(i3, i3, bArr5, bArr6);
                }
                byte[] bArr7 = this.f29754e;
                int length = bArr7.length + i2;
                byte[] bArr8 = new byte[length];
                System.arraycopy(bArr7, 0, bArr8, 0, bArr7.length);
                System.arraycopy(bArr6, 0, bArr8, this.f29754e.length, i2);
                AbstractC12442e.crashlytics(bArr8);
                ((C8011e) this.f29756e).init(true, new C11494e((C14915e) this.f29752e, f29749e, 0, 8));
                for (int i4 = 0; i4 != length; i4 += isPro) {
                    ((C8011e) this.f29756e).tapsense(i4, i4, bArr8, bArr8);
                }
                return bArr8;
            default:
                byte[] bArr9 = (byte[]) this.f29752e;
                byte[] bArr10 = this.f29754e;
                ArrayList arrayList = (ArrayList) this.f29755e;
                C11511e c11511e = (C11511e) this.f29756e;
                if (!this.f29753e) {
                    throw new IllegalStateException("not set for wrapping");
                }
                int i5 = c11511e.f23139e;
                int i6 = c11511e.f23139e;
                int i7 = i5 << 3;
                if (i % i7 != 0) {
                    throw new RuntimeException(AbstractC17861e.smaato(i6 << 3, " bytes", new StringBuilder("wrap data must be a multiple of ")));
                }
                if (i > bArr.length) {
                ...
                System.arraycopy(bArr11, 0, bArr10, 0, (i6 << 3) / 2);
                arrayList.clear();
                int i13 = (i6 << 3) / 2;
                int i14 = i12 - i13;
                while (i14 != 0) {
                ...
                int i17 = 0;
                while (i17 < i11) {
                    System.arraycopy(bArr10, 0, bArr11, 0, (i6 << 3) / i8);
                    int i18 = (i6 << 3) / i8;
                    System.arraycopy(arrayList.get(0), 0, bArr11, i18, i18);
                    c11511e.tapsense(0, 0, bArr11, bArr11);
                    i17++;
                    appmetrica(i17, bArr9);
                    ...
                    int i22 = i8;
                    while (i22 < i9) {
                        System.arraycopy(arrayList.get(i22 - 1), 0, arrayList.get(i22 - 2), 0, (i6 << 3) / 2);
                        i22++;
                        i8 = i8;
                    }
                    System.arraycopy(bArr11, 0, arrayList.get(i9 - 2), 0, (i6 << 3) / 2);
                }
                System.arraycopy(bArr10, 0, bArr11, 0, (i6 << 3) / 2);
                int i23 = (i6 << 3) / 2;
                for (int i24 = 0; i24 < i10; i24++) {
                    System.arraycopy(arrayList.get(i24), 0, bArr11, i23, (i6 << 3) / 2);
                    i23 += (i6 << 3) / 2;
                }
                return bArr11;
        }
    ...
    public int metrica(int i) {
        return ((((int[]) this.f29756e)[i >>> 24] + ((int[]) this.f29752e)[(i >>> 16) & 255]) ^ ((int[]) this.f29759e)[(i >>> 8) & 255]) + ((int[]) this.f29758e)[i & 255];
    }

    public void purchase(int i, int i2, int[] iArr) {
        int[] iArr2 = (int[]) this.f29755e;
        int length = iArr.length;
        int i3 = 0;
        while (i3 < length) {
            int i4 = i ^ iArr2[0];
            for (int i5 = 1; i5 < 16; i5 += 2) {
                i2 ^= metrica(i4) ^ iArr2[i5];
                i4 ^= metrica(i2) ^ iArr2[i5 + 1];
            }
            iArr[i3] = i2 ^ iArr2[17];
            iArr[i3 + 1] = i4;
            int i6 = iArr[i3];
    ...
    public int tapsense(int i, int i2, byte[] bArr, byte[] bArr2) {
        ...
        if (!this.f29753e) {
            ...
            for (int i4 = 16; i4 > 0; i4 -= 2) {
                vip2 ^= metrica(i3) ^ iArr[i4];
                i3 ^= metrica(vip2) ^ iArr[i4 - 1];
            }
            ad(vip2 ^ iArr[0], i2, bArr2);
            ad(i3, i2 + 4, bArr2);
            return 8;
        }
        int vip3 = vip(i, bArr);
        int vip4 = vip(i + 4, bArr);
        int i5 = iArr[0] ^ vip3;
        for (int i6 = 1; i6 < 16; i6 += 2) {
            vip4 ^= metrica(i5) ^ iArr[i6];
            i5 ^= metrica(vip4) ^ iArr[i6 + 1];
        }
        ad(vip4 ^ iArr[17], i2, bArr2);
        ad(i5, i2 + 4, bArr2);
        return 8;
    }
}
