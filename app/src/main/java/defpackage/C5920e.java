...
public final class C5920e extends AbstractC2206e implements InterfaceC2227e {
    ...
    public final void init(boolean z, InterfaceC3894e interfaceC3894e) {
        if (!(interfaceC3894e instanceof C14915e)) {
            throw new IllegalArgumentException(AbstractC8703e.remoteconfig("invalid parameter passed to DES init - ", interfaceC3894e));
        }
        byte[] bArr = ((C14915e) interfaceC3894e).f29591e;
        if (bArr.length > 8) {
            throw new IllegalArgumentException("DES key too long - should be 8 bytes");
        }
        this.f12490e = license(z, bArr);
    ...
    @Override // defpackage.AbstractC2206e
    public final int[] license(boolean z, byte[] bArr) {
        byte[] bArr2;
        int i;
        int[] iArr = new int[32];
    ...
    @Override // defpackage.AbstractC2206e
    public final void metrica(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
