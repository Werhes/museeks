...
/* renamed from: eؚٕؕ, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C3206e extends AbstractC3405e implements InterfaceC10218e {
    public static final int CATALOGUE_NAME_FIELD_NUMBER = 5;
    private static final C3206e DEFAULT_INSTANCE;
    ...
    static {
        C3206e c3206e = new C3206e();
        DEFAULT_INSTANCE = c3206e;
        AbstractC3405e.tapsense(C3206e.class, c3206e);
    }
    ...
    public final Object startapp(int i) {
        ...
        if (m2467class == 2) {
            return new C15610e(DEFAULT_INSTANCE, "\u0000\u0005\u0000\u0000\u0001\u0005\u0005\u0000\u0000\u0000\u0001Ȉ\u0002Ȉ\u0003\u000b\u0004\u0007\u0005Ȉ", new Object[]{"primitiveName_", "typeUrl_", "keyManagerVersion_", "newKeyAllowed_", "catalogueName_"});
        }
        if (m2467class == 3) {
            return new C3206e();
        }
        if (m2467class == 4) {
            return new C15000e(DEFAULT_INSTANCE, 1);
        }
        if (m2467class == 5) {
