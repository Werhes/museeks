...
/* renamed from: eۣٓٛ, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes3.dex */
public abstract class AbstractC14342e {
    public static final /* synthetic */ int ad = 0;

    static {
        AbstractC14342e.class.getClassLoader();
    }
    ...
    public static void vip(Parcel parcel, IInterface iInterface) {
        if (iInterface == null) {
