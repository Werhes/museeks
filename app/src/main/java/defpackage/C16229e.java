...
/* renamed from: eٖٕٓ, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes.dex */
public final class C16229e extends MultiAutoCompleteTextView implements InterfaceC13405e {

    /* renamed from: eؙِٖ, reason: contains not printable characters */
    public static final int[] f31895e = {R.attr.popupBackground};

    /* renamed from: eًؔؐ, reason: contains not printable characters */
    public final C16911e f31896e;

    /* renamed from: eؘٙؓ, reason: contains not printable characters */
    public final C16293e f31897e;

    /* renamed from: eّٖۦ, reason: contains not printable characters */
    public final C17790e f31898e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C16229e(Context context, AttributeSet attributeSet) {
    ...
    public final void drawableStateChanged() {
        ...
        C17790e c17790e = this.f31898e;
        if (c17790e != null) {
            c17790e.license();
        }
        C16293e c16293e = this.f31897e;
        if (c16293e != null) {
            c16293e.vip();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f31897e.license();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f31897e.appmetrica();
    }
    ...
    public final InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f31896e.m4214class(onCreateInputConnection, editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z) {
        this.f31896e.m4221throw(z);
    }

    @Override // android.widget.TextView
    public void setKeyListener(KeyListener keyListener) {
        super.setKeyListener(this.f31896e.isPro(keyListener));
    }
