...
/* renamed from: eٌؔۨ, reason: invalid class name and case insensitive filesystem */
...
public final class C3027e {
    ...
    public C3027e(long j, long j2, long j3, long j4, long j5, long j6, long j7, long j8, long j9, long j10, long j11, long j12, long j13, long j14) {
        this.ad = j;
        this.vip = j2;
        this.metrica = j3;
        this.license = j4;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || C3027e.class != obj.getClass()) {
            return false;
        }
        C3027e c3027e = (C3027e) obj;
        return C3618e.metrica(this.ad, c3027e.ad) && C3618e.metrica(this.vip, c3027e.vip) && C3618e.metrica(this.metrica, c3027e.metrica) && C3618e.metrica(this.license, c3027e.license) && C3618e.metrica(this.appmetrica, c3027e.appmetrica) && C3618e.metrica(this.purchase, c3027e.purchase) && C3618e.metrica(this.billing, c3027e.billing) && C3618e.metrica(this.yandex, c3027e.yandex) && C3618e.metrica(this.startapp, c3027e.startapp) && C3618e.metrica(this.adcel, c3027e.adcel) && C3618e.metrica(this.mopub, c3027e.mopub) && C3618e.metrica(this.advert, c3027e.advert) && C3618e.metrica(this.smaato, c3027e.smaato) && C3618e.metrica(this.amazon, c3027e.amazon);
    }
