...
/* renamed from: eٌٗۛ, reason: invalid class name and case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C16893e extends C4334e {
    public C16893e(int i) {
        super(EnumC14687e.DISCNUMBER.f29091e, String.valueOf(i));
    ...
    public final void ad(ByteBuffer byteBuffer) {
        ...
        if (this.f9469e.size() > 1 && ((Short) this.f9469e.get(1)).shortValue() > 0) {
