...
/* renamed from: eؑ۟ؖ, reason: invalid class name and case insensitive filesystem */
...
public final class C0583e {
    ...
    public /* synthetic */ C0583e() {
        this(6);
    }

    public C0583e(int i) {
        this.ad = AbstractC12981e.ad;
        Object[] objArr = AbstractC10115e.metrica;
        this.vip = objArr;
        this.metrica = objArr;
        if (i >= 0) {
            yandex(AbstractC12981e.license(i));
        } else {
    ...
    */
    public final java.lang.Object advert(java.lang.Object r14) {
        /*
            r13 = this;
            r0 = 0
            if (r14 == 0) goto L8
        ...
        L6c:
            if (r10 < 0) goto L73
            java.lang.Object r14 = r13.smaato(r10)
            return r14
        L73:
            r14 = 0
            return r14
        L75:
            ...
            goto L16
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.C0583e.advert(java.lang.Object):java.lang.Object");
    }

    public final void amazon(Object obj, Object obj2) {
        int purchase = purchase(obj);
        if (purchase < 0) {
            purchase = ~purchase;
        }
        this.vip[purchase] = obj;
        this.metrica[purchase] = obj2;
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object billing(java.lang.Object r14) {
        /*
            r13 = this;
            r0 = 0
            if (r14 == 0) goto L8
        ...
        L6c:
            if (r10 < 0) goto L73
            java.lang.Object[] r14 = r13.metrica
            r14 = r14[r10]
            return r14
        L73:
            r14 = 0
        ...
        L75:
            ...
            goto L16
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.C0583e.billing(java.lang.Object):java.lang.Object");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (c0583e.appmetrica != this.appmetrica) {
            return false;
        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128) {
                            ...
                            if (obj3 == null) {
                                if (c0583e.billing(obj2) != null || !c0583e.metrica(obj2)) {
                                    break loop0;
                                }
                            } else if (!obj3.equals(c0583e.billing(obj2))) {
                                return false;
                            }
                        }
                        j >>= 8;
        ...
        if (length >= 0) {
            ...
            while (true) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    int i2 = 8 - ((~(i - length)) >>> 31);
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j) < 128 && AbstractC7890e.billing(obj, objArr[(i << 3) + i3])) {
                            return true;
                        }
                        j >>= 8;
                    }
    ...
    */
    public final boolean metrica(java.lang.Object r18) {
        ...
        L75:
            ...
            goto L1c
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.C0583e.metrica(java.lang.Object):boolean");
    }

    public final Object mopub(Object obj, Object obj2) {
        int purchase = purchase(obj);
        if (purchase < 0) {
            purchase = ~purchase;
        }
        Object[] objArr = this.metrica;
        Object obj3 = objArr[purchase];
        this.vip[purchase] = obj;
        objArr[purchase] = obj2;
        return obj3;
    }
        ...
        while (true) {
            ...
            if ((((~j4) << 6) & j4 & (-9187201950435737472L)) != 0) {
                ...
                if (this.purchase != 0 || ((this.ad[appmetrica >> 3] >> ((appmetrica & 7) << 3)) & 255) == 254) {
                                ...
                                if (j11 != 128 && j11 == 254) {
                                    ...
                                    if (((appmetrica2 - i26) & i16) / i19 == ((i22 - i26) & i16) / i19) {
                                        ...
                                        if (((j12 >> i29) & j) == 128) {
                                            i = i16;
                                            objArr = objArr2;
                                            jArr4[i28] = ((~(j << i29)) & j12) | ((r8 & 127) << i29);
                                            jArr4[i23] = (jArr4[i23] & (~(j << i24))) | (128 << i24);
                                            objArr[appmetrica2] = objArr[i22];
                                            objArr[i22] = null;
                                            objArr3[appmetrica2] = objArr3[i22];
                                            objArr3[i22] = null;
                                        } else {
                                            i = i16;
                                            objArr = objArr2;
                                            jArr4[i28] = ((r8 & 127) << i29) | ((~(j << i29)) & j12);
                                            Object obj3 = objArr[appmetrica2];
                                            objArr[appmetrica2] = objArr[i22];
                                            objArr[i22] = obj3;
                                            Object obj4 = objArr3[appmetrica2];
                                            objArr3[appmetrica2] = objArr3[i22];
                                            objArr3[i22] = obj4;
                                            i22--;
                                        }
                    ...
                    Object[] objArr5 = this.metrica;
                    int i30 = this.license;
                    yandex(vip);
                    long[] jArr6 = this.ad;
                    Object[] objArr6 = this.vip;
                    Object[] objArr7 = this.metrica;
                    ...
                    while (i32 < i30) {
                        if (((jArr5[i32 >> 3] >> ((i32 & 7) << 3)) & 255) < 128) {
                            ...
                            jArr[i34] = j14;
                            jArr[(((appmetrica3 - 7) & i31) + (i31 & 7)) >> 3] = j14;
                            objArr6[appmetrica3] = obj5;
                            objArr7[appmetrica3] = objArr5[i32];
                        } else {
                            jArr = jArr6;
                            jArr2 = jArr5;
                        }
                ...
                this.purchase = i36 - (((j15 >> i38) & j) == j3 ? 1 : 0);
                int i39 = this.license;
                long j16 = (j15 & (~(j << i38))) | (j2 << i38);
                jArr7[i37] = j16;
                jArr7[(((appmetrica - 7) & i39) + (i39 & 7)) >> 3] = j16;
                return ~appmetrica;
            }
            i8 += 8;
            i7 = (i7 + i8) & i6;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final boolean vip(java.lang.Object r18) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        L75:
            ...
            goto L1c
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.C0583e.vip(java.lang.Object):boolean");
    }
    ...
    public final void yandex(int i) {
        ...
        this.purchase = AbstractC12981e.ad(this.license) - this.appmetrica;
        Object[] objArr = AbstractC10115e.metrica;
        this.vip = max == 0 ? objArr : new Object[max];
        if (max != 0) {
