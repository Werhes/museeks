...
public final class Catalog2Block_PodcastsBlockJsonAdapter extends AbstractC13345e {
    public final C16911e ad = C16911e.firebase("id", "layout", "actions", "next_from", "listen_events", "podcast_items_ids");
    ...
    public Catalog2Block_PodcastsBlockJsonAdapter(C14172e c14172e) {
    ...
    public final void purchase(AbstractC3442e abstractC3442e, Object obj) {
        ...
        this.vip.purchase(abstractC3442e, podcastsBlock.ad);
        abstractC3442e.loadAd("layout");
        this.metrica.purchase(abstractC3442e, podcastsBlock.vip);
        abstractC3442e.loadAd("actions");
        this.license.purchase(abstractC3442e, podcastsBlock.metrica);
        abstractC3442e.loadAd("next_from");
        this.appmetrica.purchase(abstractC3442e, podcastsBlock.license);
        abstractC3442e.loadAd("listen_events");
        List list = podcastsBlock.appmetrica;
        AbstractC13345e abstractC13345e = this.purchase;
        abstractC13345e.purchase(abstractC3442e, list);
        abstractC3442e.loadAd("podcast_items_ids");
        abstractC13345e.purchase(abstractC3442e, podcastsBlock.purchase);
    ...
    public final Object vip(AbstractC17080e abstractC17080e) {
        ...
        while (true) {
            if (!abstractC17080e.Signature()) {
                ...
                if (i == -61) {
                    return new Catalog2Block.PodcastsBlock(str2, str3, list2, list3, list4, catalog2Layout);
                }
                if ((i & 4) != 0) {
                    list2 = null;
                }
                ...
                return new Catalog2Block.PodcastsBlock(str2, str, list, list3, list4, catalog2Layout);
            }
