...
public final class Catalog2Block_CuratorGroupBlockJsonAdapter extends AbstractC13345e {
    public final C16911e ad = C16911e.firebase("id", "layout", "actions", "next_from", "listen_events", "group_ids");
    ...
    public Catalog2Block_CuratorGroupBlockJsonAdapter(C14172e c14172e) {
    ...
    public final void purchase(AbstractC3442e abstractC3442e, Object obj) {
        ...
        this.vip.purchase(abstractC3442e, curatorGroupBlock.ad);
        abstractC3442e.loadAd("layout");
        this.metrica.purchase(abstractC3442e, curatorGroupBlock.vip);
        abstractC3442e.loadAd("actions");
        this.license.purchase(abstractC3442e, curatorGroupBlock.metrica);
        abstractC3442e.loadAd("next_from");
        this.appmetrica.purchase(abstractC3442e, curatorGroupBlock.license);
        abstractC3442e.loadAd("listen_events");
        List list = curatorGroupBlock.appmetrica;
        AbstractC13345e abstractC13345e = this.purchase;
        abstractC13345e.purchase(abstractC3442e, list);
        abstractC3442e.loadAd("group_ids");
        abstractC13345e.purchase(abstractC3442e, curatorGroupBlock.purchase);
    ...
    public final Object vip(AbstractC17080e abstractC17080e) {
        ...
        while (true) {
            if (!abstractC17080e.Signature()) {
                ...
                if (i == -61) {
                    return new Catalog2Block.CuratorGroupBlock(str2, str3, list2, list3, list4, catalog2Layout);
                }
                if ((i & 4) != 0) {
                    list2 = null;
                }
                ...
                return new Catalog2Block.CuratorGroupBlock(str2, str, list, list3, list4, catalog2Layout);
            }
