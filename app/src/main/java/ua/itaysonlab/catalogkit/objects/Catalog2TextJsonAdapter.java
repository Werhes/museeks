...
public final class Catalog2TextJsonAdapter extends AbstractC13345e {
    public final C16911e ad = C16911e.firebase("id", "text", "collapsed_lines");
    public final AbstractC13345e metrica;
    public final AbstractC13345e vip;

    public Catalog2TextJsonAdapter(C14172e c14172e) {
        C3295e c3295e = C3295e.f7451e;
        this.vip = c14172e.vip(String.class, c3295e, "id");
        this.metrica = c14172e.vip(Integer.TYPE, c3295e, "collapsed_lines");
    }
    ...
    public final void purchase(AbstractC3442e abstractC3442e, Object obj) {
        ...
        String str = catalog2Text.ad;
        AbstractC13345e abstractC13345e = this.vip;
        abstractC13345e.purchase(abstractC3442e, str);
        abstractC3442e.loadAd("text");
        abstractC13345e.purchase(abstractC3442e, catalog2Text.vip);
        abstractC3442e.loadAd("collapsed_lines");
        this.metrica.purchase(abstractC3442e, Integer.valueOf(catalog2Text.metrica));
    ...
    public final Object vip(AbstractC17080e abstractC17080e) {
        ...
        while (true) {
            ...
            if (mo2308extends != -1) {
                ...
                if (mo2308extends == 0) {
                    ...
                    if (vip3 == null) {
                        set = AbstractC0869e.subs("collapsed_lines", "collapsed_lines", abstractC17080e, set);
                    } else {
        ...
        if (set.size() == 0) {
            return i == -5 ? new Catalog2Text(str, i2, str2) : new Catalog2Text(i2, i, str, str2);
        }
