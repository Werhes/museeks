...
public final class Catalog2Block_AudioFollowingsUpdateInfoBlockJsonAdapter extends AbstractC13345e {
    public final C16911e ad = C16911e.firebase("id", "layout", "actions", "listen_events", "next_from", "audio_followings_update_info_ids");
    ...
    public Catalog2Block_AudioFollowingsUpdateInfoBlockJsonAdapter(C14172e c14172e) {
    ...
    public final void purchase(AbstractC3442e abstractC3442e, Object obj) {
        ...
        this.vip.purchase(abstractC3442e, audioFollowingsUpdateInfoBlock.ad);
        abstractC3442e.loadAd("layout");
        this.metrica.purchase(abstractC3442e, audioFollowingsUpdateInfoBlock.vip);
        abstractC3442e.loadAd("actions");
        this.license.purchase(abstractC3442e, audioFollowingsUpdateInfoBlock.metrica);
        abstractC3442e.loadAd("listen_events");
        List list = audioFollowingsUpdateInfoBlock.license;
        ...
        this.purchase.purchase(abstractC3442e, audioFollowingsUpdateInfoBlock.appmetrica);
        abstractC3442e.loadAd("audio_followings_update_info_ids");
        abstractC13345e.purchase(abstractC3442e, audioFollowingsUpdateInfoBlock.purchase);
    ...
    public final Object vip(AbstractC17080e abstractC17080e) {
        ...
        while (true) {
            if (!abstractC17080e.Signature()) {
                ...
                if (i == -61) {
                    return new Catalog2Block.AudioFollowingsUpdateInfoBlock(str2, str3, list3, list4, list5, catalog2Layout);
                }
                if ((i & 4) != 0) {
                    list3 = null;
                }
                ...
                return new Catalog2Block.AudioFollowingsUpdateInfoBlock(str2, str, list, list2, list5, catalog2Layout);
            }
