...
public final class Catalog2Block_AudioBooksPersonsBlockJsonAdapter extends AbstractC13345e {
    public final C16911e ad = C16911e.firebase("id", "layout", "actions", "next_from", "listen_events", "audio_books_person_ids");
    ...
    public Catalog2Block_AudioBooksPersonsBlockJsonAdapter(C14172e c14172e) {
        ...
        this.billing = c14172e.vip(AbstractC18453e.purchase(List.class, Integer.class), c3295e, "audio_books_person_ids");
    }
    ...
    public final void purchase(AbstractC3442e abstractC3442e, Object obj) {
        ...
        this.vip.purchase(abstractC3442e, audioBooksPersonsBlock.ad);
        abstractC3442e.loadAd("layout");
        this.metrica.purchase(abstractC3442e, audioBooksPersonsBlock.vip);
        abstractC3442e.loadAd("actions");
        this.license.purchase(abstractC3442e, audioBooksPersonsBlock.metrica);
        abstractC3442e.loadAd("next_from");
        this.appmetrica.purchase(abstractC3442e, audioBooksPersonsBlock.license);
        abstractC3442e.loadAd("listen_events");
        this.purchase.purchase(abstractC3442e, audioBooksPersonsBlock.appmetrica);
        abstractC3442e.loadAd("audio_books_person_ids");
        this.billing.purchase(abstractC3442e, audioBooksPersonsBlock.purchase);
    ...
    public final Object vip(AbstractC17080e abstractC17080e) {
        ...
        while (abstractC17080e.Signature()) {
            switch (abstractC17080e.mo2308extends(this.ad)) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    obj4 = this.billing.vip(abstractC17080e);
                    i &= -33;
                    break;
            }
        }
        ...
        if (i == -61) {
            return new Catalog2Block.AudioBooksPersonsBlock(str2, str3, list2, list3, list4, catalog2Layout);
        }
        if ((i & 4) != 0) {
            list2 = null;
        }
        ...
        return new Catalog2Block.AudioBooksPersonsBlock(str2, str, list, list3, list4, catalog2Layout);
    }
}
