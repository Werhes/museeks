...
@Metadata(d1 = {"\u0000\n\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\b\u0007\u0018\u00002\u00020\u0001¨\u0006\u0002"}, d2 = {"Lua/itaysonlab/vkapi2/objects/message/ConversationAudioElement;", BuildConfig.FLAVOR, "app_publicReleaseRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class ConversationAudioElement {
    public final NewsfeedAttachment ad;

    public ConversationAudioElement(NewsfeedAttachment newsfeedAttachment) {
        this.ad = newsfeedAttachment;
    }
}
