...
public final class e6 extends g1 implements o8 {
    ...
    public final f2 M0(u3 u3Var, Spliterator spliterator, IntFunction intFunction) {
        switch (this.s) {
            case 0:
                ...
                long[] jArr = (long[]) ((d2) u3Var.k0(spliterator, true, intFunction)).b();
                Arrays.sort(jArr);
                return new j3(jArr);
            case 1:
    ...
    public Spliterator N0(a aVar, Spliterator spliterator) {
        switch (this.s) {
            case 1:
                return x6.ORDERED.n(aVar.m) ? M0(aVar, spliterator, new a1(22)).spliterator() : new u8((j$.util.z0) aVar.G0(spliterator), 1);
            case 2:
                return x6.ORDERED.n(aVar.m) ? M0(aVar, spliterator, new a1(23)).spliterator() : new u8((j$.util.z0) aVar.G0(spliterator), 0);
            default:
    ...
    public final k5 P0(int i, k5 k5Var) {
        switch (this.s) {
            case 0:
                ...
                return x6.SIZED.n(i) ? new f5(k5Var) : new f5(k5Var);
            case 1:
                return new k8(this, k5Var);
            default:
                return new l8(this, k5Var, false);
        }
    }

    @Override // j$.util.stream.o8
    public p8 i(x1 x1Var, boolean z) {
        return new l8(this, x1Var, z);
    }
}
