...
public final class s5 extends x {
    public final /* synthetic */ long s;
    public final /* synthetic */ long t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s5(z zVar, int i, long j, long j2) {
        super(zVar, i);
        this.s = j;
        this.t = j2;
    }
    ...
    public final f2 M0(u3 u3Var, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (l0 > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            return u3.c0(u3Var, u3.Y(aVar.L0(), spliterator, this.s, this.t), true);
        }
        if (x6.ORDERED.n(((a) u3Var).m)) {
            return (f2) new u5(this, u3Var, spliterator, intFunction, this.s, this.t).invoke();
        }
        j$.util.t0 t0Var = (j$.util.t0) u3Var.G0(spliterator);
        long j3 = this.s;
        long j4 = this.t;
        if (j3 <= l0) {
            long j5 = l0 - j3;
        ...
        return u3.c0(this, new z7(t0Var, j2, j), true);
    }
    ...
    public final Spliterator N0(a aVar, Spliterator spliterator) {
        ...
        if (l0 > 0 && spliterator.hasCharacteristics(16384)) {
            j$.util.t0 t0Var = (j$.util.t0) aVar.G0(spliterator);
            long j = this.s;
            return new q7(t0Var, j, u3.a0(j, this.t));
        }
        if (x6.ORDERED.n(aVar.m)) {
            return ((f2) new u5(this, aVar, spliterator, new a1(17), this.s, this.t).invoke()).spliterator();
        }
        j$.util.t0 t0Var2 = (j$.util.t0) aVar.G0(spliterator);
        long j2 = this.s;
        long j3 = this.t;
        if (j2 <= l0) {
            long j4 = l0 - j2;
        ...
        return new z7(t0Var2, j2, j3);
    }

    @Override // j$.util.stream.a
    public final k5 P0(int i, k5 k5Var) {
        return new r5(this, k5Var);
    }
}
