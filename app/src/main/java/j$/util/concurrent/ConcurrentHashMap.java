...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable, u {
    ...
    public static final boolean b(l[] lVarArr, int i2, l lVar) {
        return j$.com.android.tools.r8.a.U(h.a, lVarArr, (i2 << o) + n, lVar);
    }
                                    ...
                                    if (k(lVarArr, i12) == k2) {
                                        if (i20 >= 0) {
                                            ...
                                            if (k2 instanceof q) {
                                                ...
                                                q qVar3 = qVar;
                                                l p = i25 <= 6 ? p(rVar2) : i26 != 0 ? new q(rVar2) : qVar3;
                                                l p2 = i26 <= 6 ? p(rVar7) : i25 != 0 ? new q(rVar7) : qVar3;
                                                h(lVarArr3, i12, p);
                                                h(lVarArr3, i7, p2);
                                                h(lVarArr, i12, gVar);
                                            }
