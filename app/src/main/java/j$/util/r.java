...
public final class r extends u {
    ...
    public final boolean contains(Object obj) {
        if (obj instanceof Map.Entry) {
            return this.a.contains(new p((Map.Entry) obj));
        }
        return false;
    }
    ...
    public final void forEach(Consumer consumer) {
        ...
        Collection.EL.a(this.a, new j$.time.r(1, consumer));
    }
    ...
    public final Stream parallelStream() {
        ...
        return new j$.util.stream.a(spliterator, x6.k(spliterator), true);
    }
    ...
    public final Stream stream() {
        Spliterator spliterator = spliterator();
        Objects.requireNonNull(spliterator);
        return new j$.util.stream.a(spliterator, x6.k(spliterator), false);
    }
    ...
    public final Object[] toArray() {
        ...
        for (int i = 0; i < array.length; i++) {
            array[i] = new p((Map.Entry) array[i]);
        }
        return array;
    }
