...
public final class i implements java.util.Map, Serializable, Map {
    ...
    public final Object compute(Object obj, BiFunction biFunction) {
        ...
        synchronized (this.b) {
            ...
            compute = map instanceof Map ? ((Map) map).compute(obj, biFunction) : map instanceof ConcurrentMap ? j$.com.android.tools.r8.a.i((ConcurrentMap) map, obj, biFunction) : Map.CC.$default$compute(map, obj, biFunction);
        }
        return compute;
    }
